...
export default function coursesPage() {
  ...
  const printResults = () => {
    window.open(
      `/api/exams/results-mat/print-result?result=${resultsId}`,
      "_blank"
    );
  };
  return (
    <>
      ...
      <div>BULLETIN D'EVALUATION 2024/2025</div>
      <div>
