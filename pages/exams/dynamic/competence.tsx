...
export default function coursesPage(){
    ...
    const printResults = () => {
        window.open(`/api/exams/results/dynamic-print?term_id=${termId}&student_id=${studentId}`,'_blank')
    }
    return (
        <>
    ...
    <div >
        BULLETIN D'EVALUATION 2022/2023
    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            {results.map((result, index) => {
                                                                return <>
                                                                  ...
                                                                  <td>{(termResult && termResult[`subject_${course._id}`]) ?? 0}</td> 
                                                                  <td></td>
                                                            </tr>
