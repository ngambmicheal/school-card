...
export function ExamResult({result, subjects, points, deleteResult}:{subjects:SubjectInterface[], result:ExamResultInterface|any, points:number, deleteResult:(resultId:string)=>void }){
   ...
   return  <tr>
        ...
        <th> <Link href={`/api/terms/results-special/dynamic-print?annualExam_id=${res.annualExam_id}&student_id=${res.student?._id}`}>Imprimer</Link> | <a onClick={() =>deleteResult(res._id)}> Delete</a> </th>
    </tr>
}