        ...
        <>
            ...
            <table className='table table-hover'>
                ...
                <tbody>
                    ...
                    return <tr key={term._id}>
                        <td> {term.name} </td>
                        {classe?.section?.report_type =='Maternelle' && <td> <Link href={`/exams/mat/annual?annualExam_id=${term._id}`}>Mat</Link></td> }
                        {classe?.section?.report_type =='Nursery' && <td> <Link href={`/exams/nursery/annual/?annualExam_id=${term._id}`}>Nursery</Link></td> }
