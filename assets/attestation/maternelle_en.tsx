...
export default function AttestationMaternelleEn(result:ExamResultInterface, term:ExamInterface ) {
 
    return (
        <div style={{  
            backgroundImage: "url('data:image/png;base64," + schoolLogo(term.class_id?.school!, 'attestation_nursery') + "')",
