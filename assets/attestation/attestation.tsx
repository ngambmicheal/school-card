...
export default function AttestationOnly(student:StudentInterface, classe: ClasseInterface)  {
    ...
    const {logo, childNode:reactChild} = getLogo(classeSection!, classe.school!, student);
...
const getLogo = (reportType:string, school: SchoolInterface, student:StudentInterface): {childNode:React.ReactNode, logo:string} => { 
    switch (reportType) {
        case 'Nursery':
            return {
                logo: schoolLogo(school, 'attestation_nursery'),
                childNode: <div className="anglais">
                    <h2 style={{
                            fontWeight: 'normal'
        ...
        case 'Maternelle':
            return {
                logo:schoolLogo(school, 'attestation_mat'),
                childNode: <div className="fran">
                        <h2 style={{
                                lineHeight:'50px',
                                fontWeight: 'normal'
        ...
        case 'Special':
            return  {
                logo:schoolLogo(school, 'attestation_fr'), 
                childNode: <div className="fran">
                    <h2 style={{
                            lineHeight:'50px',
                            fontWeight: 'normal'
                    ...
                    <h2 style={{
                        ...
                        Directrice du Groupe Scolaire Bilingue Privé Laïc La SEMENCE atteste que l'eleve <br />
                        <div style={{ fontWeight: 'bolder', fontSize: '60px', color: '#000065', fontFamily: 'Bradley Hand ITC', textAlign: 'center'}}>{student.name}</div>
                        a suivi avec succes le Cycle Maternel et est promu(e) en ce jour au Cycle Secondaire.
                    </h2>
                </div> 
            }
        case 'Matiere':
            return  {
                logo:schoolLogo(school, 'attestation_en'),
                childNode: <div className="fran">
                    <h2 style={{
                            lineHeight:'50px',
                            fontWeight: 'normal'
                    ...
                    <h2 style={{
                        ...
                        Directrice du Groupe Scolaire Bilingue Privé Laïc La SEMENCE atteste que l'eleve <br />
                        <div style={{ fontWeight: 'bolder', fontSize: '60px', color: '#000065', fontFamily: 'Bradley Hand ITC', textAlign: 'center'}}>{student.name}</div>
                        a suivi avec succes le Cycle Maternel et est promu(e) en ce jour au Secondary Cycle.
                    </h2>
                </div> 
            }
        default:
