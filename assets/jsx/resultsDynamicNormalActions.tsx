...
const getAppreciation = (
  ...
  if (total == 20) {
    ...
    if (value < 15) return displayName ? "SIA" : "SIA";
...
export default function resultsDynamicNormalActions(
  ...
  return (
    <>
      ...
      <div className="center" style={{ fontSize: "25px", margin: "30px 0" }}>
        REPORT CARD : {term?.name} 2024/2025
      </div>
      ...
      <table className="table1" style={{ fontSize: "20px" }}>
        <thead>
          <tr>
            ...
            <th>TERM1</th>
            <th colSpan={2}>APPRECIATION CODE</th>
          </tr>
        </thead>
        <tbody>
      ...
      <div className="center">
        <p style={{ fontSize: "20px", margin: "30px 0" }}>
          CODES : NA = Not Acquired, SIA= Skill In Acquisition, A = Acquired, A+
          = Expert
        </p>
      </div>
