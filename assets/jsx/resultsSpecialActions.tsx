...
export default function resultsSpecialActions(
  ...
  return (
    <>
      ...
      <div className="center" style={{ fontSize: "25px", margin: "30px 0" }}>
        BULLETIN D'EVALUATION : {results.exam_id?.name} 2024/2025
      </div>
                ...
                <tr>
                  ...
                  <td>
                    {getAppreciation(
                      ...
                      results.exam_id?.[`point_${subject._id}`],
                      false,
                      subject.name,
                    )}
                  </td>
